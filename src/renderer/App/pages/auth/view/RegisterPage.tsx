...
import { FcBusinessman, FcFeedback, FcLock } from "react-icons/fc";
import { useNavigate } from "react-router";
import { useAppDispatch, useAppSelector } from "../../../store";
import { InitialUser, IUser } from "../../../models/UserModel";
...
export default function RegisterPage() {
  ...
  function HandleSubmit() {
    dispatch(
      UserAuthenticationThunk({ data: info, route: PostRoutes.UserRegister })
    );
  }
      ...
      >
        ...
        >
          <Stack
            ...
            sx={(theme) => ({ padding: theme.spacing(1, 0), width: "100%" })}
            direction="row"
          ></Stack>
